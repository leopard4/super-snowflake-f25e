...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/super-snowflake-f25e
```

A live public deployment of this template is available at [https://super-snowflake-f25e.templates.workers.dev](https://super-snowflake-f25e.templates.workers.dev)
